 ...
 */
class Client extends \MISA\MprojectBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MISA\\MprojectBundle\\Entity\\Client' . "\0" . 'projects', '' . "\0" . 'MISA\\MprojectBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'MISA\\MprojectBundle\\Entity\\Client' . "\0" . 'nom');
        }
